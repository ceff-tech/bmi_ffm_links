...
load("data_output/00_bmi_samples_distinct_csci.rda") # n=5662

# ALL BMI DISTINCT STATIONS (bmi_stations_distinct)
load("data_output/00_bmi_stations_distinct.rda") # n=2935
...
sel_bmi_gages <- inner_join(bmi_station_h12, gages_h12, by="HUC_12") %>% 
...
# get BMI Stations NOT selected with CSCI (n=2300)
...
write_rds(sel_bmi_gages_csci, file="data_output/03_selected_bmi_station_h12_all_gages_csci.rds")
write_rds(sel_bmi_gages, file="data_output/03_selected_bmi_station_h12_all_gages.rds")
...
sel_bmi_gages_csci <- readRDS("data_output/03_selected_bmi_station_h12_all_gages_csci.rds")
sel_bmi_gages <- readRDS("data_output/03_selected_bmi_station_h12_all_gages.rds")
