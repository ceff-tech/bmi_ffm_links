...
## Mapping Out Sampling Sites

Here are sampling sites by method.

### Maps

```{r sitesmap, fig.show='hold'}

knitr::include_graphics(paste0(here::here(),"/figs/00_bmi_station_by_methods.png"))
