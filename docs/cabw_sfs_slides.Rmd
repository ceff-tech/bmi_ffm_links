---
title: "CABW BMI & Flow Metrics"
subtitle: "Linking Environmental Flows <br/> with Benthic Macroinverts"
author: "Ryan Peek"
institute: "UC Davis Center for Watershed Sciences"
date: "2019-Oct-24 (updated: `r Sys.Date()`)"
output:
...
---
background-image: url(https://watershed.ucdavis.edu/files/cws_logo_48.png)
...
Image credit: or other presenter notes to self

---
class: inverse, center, middle

# CA Map of All BMI Sites

### 300k+ Sites, show sampling types/methods

 *Have huge dataset collected from 1994 to present*

---
class: inverse, center, middle

# CA Map of USGS Stations

### Show all, then show just "Reference" sites

*Need to define reference*

---

# Outline Basic Filter/Linking Steps

Sites were linked via:

 - USGS & BMI Station were in same HUC12

--

This yielded approx n=SITES statewide;<sup>1</sup>

--

- And USGS station and metrics were calculated as per CEFF<sup>2</sup>

.footnote[

[1] Sites [bmi](bmi.ucdavis.eduData From here)

[2] CEFF [eFlows](eflows.ucdavis.edu)

]

---
background-image: url(https://watershed.ucdavis.edu/static/cws/MtnMeadows_creek.jpg)
