...
DiagrammeR("graph TB;
  ...
  K(Reference Models: Identify metrics <br> that are best predictors of <br> seasonality/unimpaired flow)
  L(Alteration Models: Identify metrics that most strongly indicate flow alteration)
  ...
  H -->J
  I -->J
  J -- <i><b>REFERENCE Models</b></i> -->K
  J -- <i><b>ALTERATION Models</b></i> -->L
